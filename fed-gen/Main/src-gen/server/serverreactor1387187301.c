...
#include "include/api/set.h"
void serverreactor1387187301reaction_function_0(void* instance_args){
    _serverreactor1387187301_self_t* self = (_serverreactor1387187301_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    serverreactor1387187301_out_parameter_t* out_parameter = &self->_lf_out_parameter;
    #line 32 "/mnt/c/Users/jacky/Desktop/Memory_Leak/fed-gen/Main/src/server.lf"
    // Acquire the GIL (Global Interpreter Lock) to be able to call Python APIs.
    PyGILState_STATE gstate;
    gstate = PyGILState_Ensure();
    LF_PRINT_DEBUG("Calling reaction function serverreactor1387187301.reaction_function_0");
    PyObject *rValue = PyObject_CallObject(
        self->_lf_py_reaction_function_0, 
        Py_BuildValue("(O)", convert_C_port_to_py(out_parameter, -2))
    );
    if (rValue == NULL) {
        lf_print_error("FATAL: Calling reaction serverreactor1387187301.reaction_function_0 failed.");
        if (PyErr_Occurred()) {
            PyErr_PrintEx(0);
...
#include "include/api/set.h"
void serverreactor1387187301reaction_function_1(void* instance_args){
    _serverreactor1387187301_self_t* self = (_serverreactor1387187301_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    serverreactor1387187301_in_parameter_t* in_parameter = self->_lf_in_parameter;
    ...
    PyGILState_STATE gstate;
    gstate = PyGILState_Ensure();
    LF_PRINT_DEBUG("Calling reaction function serverreactor1387187301.reaction_function_1");
    PyObject *rValue = PyObject_CallObject(
    ...
    if (rValue == NULL) {
        lf_print_error("FATAL: Calling reaction serverreactor1387187301.reaction_function_1 failed.");
        if (PyErr_Occurred()) {
            PyErr_PrintEx(0);
            PyErr_Clear(); // this will reset the error indicator so we can run Python code again
        }
...
_serverreactor1387187301_self_t* new_serverreactor1387187301() {
    _serverreactor1387187301_self_t* self = (_serverreactor1387187301_self_t*)_lf_new_reactor(sizeof(_serverreactor1387187301_self_t));
    ...
    #line 30 "/mnt/c/Users/jacky/Desktop/Memory_Leak/fed-gen/Main/src/server.lf"
    self->_lf__reaction_0.function = serverreactor1387187301reaction_function_0;
    #line 30 "/mnt/c/Users/jacky/Desktop/Memory_Leak/fed-gen/Main/src/server.lf"
    ...
    #line 37 "/mnt/c/Users/jacky/Desktop/Memory_Leak/fed-gen/Main/src/server.lf"
    self->_lf__reaction_1.function = serverreactor1387187301reaction_function_1;
    #line 37 "/mnt/c/Users/jacky/Desktop/Memory_Leak/fed-gen/Main/src/server.lf"
