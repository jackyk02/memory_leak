...
do { \
    _lf_action_table[0] = (lf_action_base_t*)&server_main_self[0]->_lf_networkMessage; \
    /* Add trigger server_main_self[0]->_lf__inputControlReactionTrigger to the global list of network input ports. */ \
