...
void server2107671597_mainreaction_function_0(void* instance_args) {
    _server2107671597_main_main_self_t* self = (_server2107671597_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct server {
        serverreactor1387187301_in_parameter_t* in_parameter;
    
    } server;
    // Expose the action struct as a local variable whose name matches the action name.
    server2107671597_main_inputControlReactionTrigger_t* inputControlReactionTrigger = &self->_lf_inputControlReactionTrigger;
...
#include "include/api/set.h"
void server2107671597_mainreaction_function_1(void* instance_args) {
    _server2107671597_main_main_self_t* self = (_server2107671597_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct server {
        serverreactor1387187301_in_parameter_t* in_parameter;
    ...
    // Expose the action struct as a local variable whose name matches the action name.
    server2107671597_main_networkMessage_t* networkMessage = &self->_lf_networkMessage;
    // Set the fields of the action struct to match the current trigger.
...
#include "include/api/set_undef.h"
#include "include/api/set.h"
void server2107671597_mainreaction_function_2(void* instance_args) {
    _server2107671597_main_main_self_t* self = (_server2107671597_main_main_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    struct server {
        serverreactor1387187301_out_parameter_t* out_parameter;
...
#include "include/api/set_undef.h"
_server2107671597_main_main_self_t* new_server2107671597_main() {
    _server2107671597_main_main_self_t* self = (_server2107671597_main_main_self_t*)_lf_new_reactor(sizeof(_server2107671597_main_main_self_t));
    ...
    #line 60 "/mnt/c/Users/jacky/Desktop/Memory_Leak/fed-gen/Main/src/server.lf"
    self->_lf__reaction_0.function = server2107671597_mainreaction_function_0;
    #line 60 "/mnt/c/Users/jacky/Desktop/Memory_Leak/fed-gen/Main/src/server.lf"
    ...
    #line 68 "/mnt/c/Users/jacky/Desktop/Memory_Leak/fed-gen/Main/src/server.lf"
    self->_lf__reaction_1.function = server2107671597_mainreaction_function_1;
    #line 68 "/mnt/c/Users/jacky/Desktop/Memory_Leak/fed-gen/Main/src/server.lf"
    ...
    #line 89 "/mnt/c/Users/jacky/Desktop/Memory_Leak/fed-gen/Main/src/server.lf"
    self->_lf__reaction_2.function = server2107671597_mainreaction_function_2;
    #line 89 "/mnt/c/Users/jacky/Desktop/Memory_Leak/fed-gen/Main/src/server.lf"
