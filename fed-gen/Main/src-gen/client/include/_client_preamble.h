...
do { \
    _lf_action_table[0] = (lf_action_base_t*)&client_main_self[0]->_lf_networkMessage_0; \
    _fed.trigger_for_network_output_control_reactions=&client_main_self[0]->_lf__outputControlReactionTrigger; \
} \
while (0)
/**
