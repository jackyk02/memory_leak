...
#include "include/Main/_lf_GenDelay_0.h"
#include "_lf_gendelay_0542839598.h"
#include "include/api/set.h"
void _lf_gendelay_0542839598reaction_function_0(void* instance_args) {
    __lf_gendelay_0542839598_self_t* self = (__lf_gendelay_0542839598_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    // Expose the action struct as a local variable whose name matches the action name.
    _lf_gendelay_0542839598_act_t* act = &self->_lf_act;
    ...
    _lf_gendelay_0542839598_out_t* out = &self->_lf_out;
    lf_set(out, act->token->value);
}
#include "include/api/set_undef.h"
#include "include/api/set.h"
void _lf_gendelay_0542839598reaction_function_1(void* instance_args) {
    __lf_gendelay_0542839598_self_t* self = (__lf_gendelay_0542839598_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _lf_gendelay_0542839598_inp_t* inp = self->_lf_inp;
...
#include "include/api/set_undef.h"
__lf_gendelay_0542839598_self_t* new__lf_gendelay_0542839598() {
    __lf_gendelay_0542839598_self_t* self = (__lf_gendelay_0542839598_self_t*)_lf_new_reactor(sizeof(__lf_gendelay_0542839598_self_t));
    self->_lf_act.trigger = &self->_lf__act;
    // Set input by default to an always absent default input.
    self->_lf_inp = &self->_lf_default__inp;
    self->_lf__reaction_0.number = 0;
    self->_lf__reaction_0.function = _lf_gendelay_0542839598reaction_function_0;
    ...
    self->_lf__reaction_1.function = _lf_gendelay_0542839598reaction_function_1;
