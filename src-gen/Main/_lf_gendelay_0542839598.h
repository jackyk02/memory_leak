...
typedef struct {
    ...
    interval_t delay;
    _lf_gendelay_0542839598_act_t _lf_act;
    _lf_gendelay_0542839598_inp_t* _lf_inp;
    // width of -2 indicates that it is not a multiport.
    int _lf_inp_width;
    // Default input (in case it does not get connected)
    _lf_gendelay_0542839598_inp_t _lf_default__inp;
    _lf_gendelay_0542839598_out_t _lf_out;
    int _lf_out_width;
    ...
    #endif // FEDERATED
} __lf_gendelay_0542839598_self_t;
__lf_gendelay_0542839598_self_t* new__lf_gendelay_0542839598();
#endif // _LF_GENDELAY_0542839598_H
